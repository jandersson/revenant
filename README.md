...
![The standalone chat window: LNet's welcome, a channel message reflected back as You, a friend's reply on the DRPrime channel, a private exchange, and a ;chat to command being typed; the status bar reads Connected as Lanival](docs/chat-window.png)
