...
# Uncaptured: the catalyst's turn, shaped like the water line.
NEED_CATALYST = (
    CRUSHED + "You need a catalyst to continue crafting some unfinished nemoih salve.\n"
)
FINISHED = "You finish crafting some nemoih salve.\nRoundtime: 20 sec.\n"
...
def test_a_finished_salve_is_stowed_counted_and_the_next_started():
    fake = Fake(
        {
            "study my book": [STUDIED],
            "get my pestle": [""] * 6,
