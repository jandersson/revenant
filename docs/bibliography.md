...
| `;athletics`, `client/game/climbs.py` | Elanthipedia's Climbing and Swimming list and [Athletics](https://elanthipedia.play.net/Athletics) | The climbing spots, their rank bands, the armed-climb column and the spot conditions, keyed to community-map room ids. |
