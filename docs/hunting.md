...
| gem_pouch | finds are tried into the pouch first; what the pouch refuses is stowed like loot. What a SEARCH leaves on the ground is read off the room's listing before and after it (`client/game/loot.py`, 2026-09-23), whatever the game called it: coins are GOT, a box goes into the loot container unopened, anything else is pocketed; the answer's own wording ("You find a small ruby.", "The grendel was carrying some waermodi stones, ...") is the second look |
